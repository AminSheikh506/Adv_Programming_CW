...
public class HakedGui {
    ...
    static JPanel makeModeCard(String icon, String title,
        ...
        JPanel card = new JPanel(new GridLayout(3, 1, 0, 6)) {
            ...
            protected void paintComponent(Graphics g) {
                ...
                g2.setColor(hovered ? new Color(0x232D42) : BG_INPUT);
                g2.fillRoundRect(0, 0, getWidth(), getHeight(), 12, 12);

                // Border - accent on hover, normal otherwise
                g2.setColor(hovered ? COL_ACCENT : COL_BORDER);
    ...
    //  TOP nav bar  (app name, username, minimise, close)
    //  CENTRE chat area (bubbles) + online sidebar
    //  BOTTOM message input bar  (text field + SEND + LEAVE)
    ...
    //  invokeLater ensures it runs after the layout has finished.
    void scrollToBottom() {
    ...
    //  SECTION 13 - Main method to run the program
    //  Java starts here. Three steps, top to bottom.
...
//        //  SECTION TEST AND DEBUG [ Can remove it later]
//        // ----------------------------------------------//
